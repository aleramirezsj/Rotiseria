...
namespace Rotiseria.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,RazonSocial,Direccion,Celular,Telefono,Observaciones")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,RazonSocial,Direccion,Celular,Telefono,Observaciones")] Proveedor proveedor)
        {
            if (ModelState.IsValid)
            {
