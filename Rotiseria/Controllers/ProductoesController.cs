...
namespace Rotiseria.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        {
            var productoes = db.Productoes.Include(p => p.CategoriaProducto);
        ...
        {
            ViewBag.CategoriaProductoId = new SelectList(db.Categorias, "Id", "Nombre");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Cantidad,PrecioCosto,PrecioVenta,Imagen,CategoriaProductoId")] Producto producto)
        {
            ...
            ViewBag.CategoriaProductoId = new SelectList(db.Categorias, "Id", "Nombre", producto.CategoriaProductoId);
            return View(producto);
        }
